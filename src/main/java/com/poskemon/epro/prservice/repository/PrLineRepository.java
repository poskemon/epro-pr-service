...
public interface PrLineRepository extends JpaRepository<PrLine, Long>, PrLineRepositoryCustom {
    ...
    @Query(value = "select pl, ph, i " +
        ...
        "and (:#{#purchaseUnitReq.rfqNo} = -1L or (:#{#purchaseUnitReq.rfqNo} = -2L and pl.rfqNo is null) or pl.rfqNo = :#{#purchaseUnitReq.rfqNo}) order by ph.prHeaderSeq desc, pl.prLine")
